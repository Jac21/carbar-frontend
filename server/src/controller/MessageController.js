...
function MessageController(request, response) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const key = "&key=" + env_2.googleMapsApiKey;
        ...
        users.forEach(function (user) {
            ...
            const googleMapsQuery = googleMapsApiEndpoint +
                units +
                origins +
                destinations +
                mode +
            ...
            https
                ...
                res.on("end", function () {
                    ...
                    if (numberOfMins < 15) {
                        const client = require("twilio")(env_1.accountSid, env_1.authToken);
                        client.messages
                            .create({
                            // this is message body for texting
                            body: "Welcome to Car Bar! The Car Bar closest to you is a " +
                                timeToDestination +
                                " walk away from you!",
