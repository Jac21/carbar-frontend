...
import { accountSid, authToken } from "../../env";
      ...
      .get(googleMapsQuery, res => {
        ...
        res.on("end", function() {
          ...
          var timeToDestination =
            mapsResponse.rows[0].elements[0].duration.text;
          ...
          if (numberOfMins < 15) {
            ...
            client.messages
              .create({
                ...
                body:
                  "Welcome to Car Bar! The Car Bar closest to you is a " +
                  timeToDestination +
                  " walk away from you!",
                ...
                mediaUrl:
                  "https://raw.githubusercontent.com/Jac21/carbar-frontend/master/public/img/V1.png",
                // user's number
